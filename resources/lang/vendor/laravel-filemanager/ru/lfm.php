...
return [
    ...
    'message-drop'      => 'Или перетащите файлы сюда',
    
    'error-rename'      => 'Имя файла уже используется!',
    'error-file-name'   => 'Имя файла не должно быть пустым!',
    ...
    'error-folder-not-found'=> 'Директория не найдена! (:folder)',
    'error-mime'        => 'Неподдерживаемый MimeType: ',
    'error-size'        => 'Превышен лимит:',
