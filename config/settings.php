...
return [
	...
	'email_tasks_created' => '1', // email-уведомления при создании задач/поручений
	'email_tasks_updated' => '1', // email-уведомления при изменении задач/поручений
	'email_tasks_deleted' => '1', // email-уведомления при удалении задач/поручений
	'email_users_created' => '1', // email-уведомления при создании пользователей
	'email_users_updated' => '1', // email-уведомления при изменении пользователей
	'email_users_deleted' => '1', // email-уведомления при удалении пользователей
	...
	'display_registration' => '1', // Отображение ссылки на регистрацию
