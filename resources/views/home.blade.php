...
@section('content')
    ...
    <div class="row">
        <div class="attention_block_text col-lg-8 offset-lg-2 col-xs-12">
            ...
            В ассортименте представлены товары от ведущих производителей. Качество продукции подтверждается наличием
            паспорта и всех необходимых сертификатов. Качество продукции подтверждается наличием паспорта и всех
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p>08.07.2018 года в силу вступил новый закон о миграционном учете - Федеральный закон № 163-ФЗ от
                        27.06.2018 г. Данный закон уточняет понятие миграционного учета и описывает, какие объекты могут
                        быть местом регистрации иностранных граждан. Самое главное уточнение нового закона о
                        миграционном учете состоит в том, что иностранный гражданин теперь может вставать на
                        миграционный учет только по месту фактического проживания.</p>
    ...
    <div class="container">
        ...
        <div class="row height_" id="contacts">
            ...
            <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-6">
                ...
                <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=4d24c871-78b4-4844-8088-0b919c191b85"
            ...
            <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-6">
                ...
                <form class="contact_us" method="POST" action="{{ route('home.contact_us') }}"
                    ...
                    <div class="form-group left_stylized_checkbox">
                        ...
                        <label class="filters main_category"
                               for="copy">{{ __('Send me a copy of this message') }}</label>
                    </div>
                    ...
                    <button disabled="disabled" name="submit" id="submit" type="submit"
                            class="btn btn-outline-primary form-control">{{ __('send_message') }}</button>
        ...
        <div class="row" id="contacts">
            ...
            <div class="col-12">
                ...
                <div class="row mt-4 center">
                    <div class="col-4">
                        <p class="h4 mb-4"><span class="b_border nowrap"><i class="fas fa-phone"></i> {{ __('phones') }}</span>
                        </p>
                    ...
                    <div class="col-4">
                        <p class="h4 mb-4"><span class="b_border nowrap"><i class="fas fa-envelope"></i> {{ __('address') }}</span>
                        </p>
                    ...
                    <div class="col-4">
                        <p class="h4 mb-4"><span class="b_border nowrap"><i
                                    class="fas fa-at"></i> {{ __('emails') }}</span></p>
