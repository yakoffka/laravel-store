    ...
    <form id="products_massupdate" action="{{ route('products.massupdate') }}" method="POST">
        ...
        @actionProductsMassupdate(['value' => 'invisible', 'i_class' => 'fa-eye-slash', 'b_class' => 'secondary', 'b_label' => 'скрыть', 'mess' => 'Скрыть выбранные товары?'])
        @actionProductsMassupdate(['value' => 'visible', 'i_class' => 'fa-eye', 'b_class' => 'primary', 'b_label' => 'отобразить', 'mess' => 'Отобразить выбранные товары?'])
