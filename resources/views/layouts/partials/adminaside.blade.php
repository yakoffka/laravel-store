...
<div class="admin_menu_block">
    @if ( Auth::user()->hasRole(['owner']) )
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseReadme" role="button" aria-expanded="false" aria-controls="collapseReadme"><i class="fas fa-book-dead"></i> Readme</span></h4>
...
<div class="admin_menu_block">
    @role('owner')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseTools" role="button" aria-expanded="false" aria-controls="collapseTools"><i class="fas fa-tools"></i> Tools</span></h4>
...
<div class="admin_menu_block">
    @auth
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseTasks" role="button" aria-expanded="false" aria-controls="collapseTasks"><i class="fas fa-tasks"></i> Tasks</span></h4>
...
<div class="admin_menu_block">
    @permission('view_products')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseProducts" role="button" aria-expanded="false" aria-controls="collapseProducts"><i class="fas fa-boxes"></i> Products</span></h4>
...
<div class="admin_menu_block">
    @permission('view_orders')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseOrders" role="button" aria-expanded="false" aria-controls="collapseOrders"><i class="fas fa-shipping-fast"></i> Orders</span></h4>
...
<div class="admin_menu_block">
    @permission('view_categories')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseCategories" role="button" aria-expanded="false" aria-controls="collapseCategories"><i class="fas fa-folder"></i> Categories</span></h4>
...
<div class="admin_menu_block">
    @permission('view_users')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseUsers" role="button" aria-expanded="false" aria-controls="collapseUsers"><i class="fas fa-users"></i> Users</span></h4>
...
<div class="admin_menu_block">
    @permission('view_roles')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseRoles" role="button" aria-expanded="false" aria-controls="collapseRoles"><i class="fas fa-sliders-h"></i> Roles</span></h4>
...
<div class="admin_menu_block">
    @permission('view_settings')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseSettings" role="button" aria-expanded="false" aria-controls="collapseSettings"><i class="fas fa-cogs"></i> Settings</span></h4>
...
<div class="admin_menu_block">
    @permission('view_actions')
        <h4 class="grey"><span class="pointer" data-toggle="collapse" href="#collapseHistory" role="button" aria-expanded="false" aria-controls="collapseHistory"><i class="fas fa-history"></i> History</span></h4>
