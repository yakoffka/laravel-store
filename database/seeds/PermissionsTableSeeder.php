    ...
    public function run()
    {
        $permissions = [
            ...
            */
            ...
            /*  4 */ ['group' => 'roles', 'name' => 'view_roles',    'display_name' => 'просмотр',  'description' => 'Просмотр ролей, включая чужие, и их истории.',],
            ...
            /*  8 */ ['group' => 'permissions', 'name' => 'view_permissions',    'display_name' => 'просмотр',  'description'  => 'Просмотр разрешений, включая чужие, и их истории.',],
            ...
            /* 12 */ ['group' => 'users', 'name' => 'view_users',    'display_name' => 'просмотр', 'description' => 'Просмотр пользователей, включая удаленных, и их истории.',],
            ...
            /* 16 */ ['group' => 'comments', 'name' => 'view_comments',    'display_name' => 'просмотр', 'description' => 'Просмотр комментариев, включая чужие и удалённые(не реализовано), и их истории.',],
            ...
            /* 20 */ ['group' => 'products', 'name' => 'view_products',    'display_name' => 'просмотр',  'description' => 'Просмотр товаров, включая скрытые, и их истории.',],
            ...
            /* 24 */ ['group' => 'categories', 'name' => 'view_categories',    'display_name' => 'просмотр',  'description' => 'Просмотр категорий, включая скрытые, и их истории.',],
            ...
            /* 28 */ ['group' => 'orders', 'name' => 'view_orders',    'display_name' => 'просмотр',  'description' => 'Просмотр заказов, включая чужие, и их истории.',],
            ...
            /* 37 */ ['group' => 'actions', 'name' => 'create_actions',  'display_name' => 'создание', 'description' => 'Создание истории',        ],
            /* 38 */ ['group' => 'actions', 'name' => 'edit_actions',    'display_name' => 'правка',   'description' => 'Редактирование истории',  ],
            /* 39 */ ['group' => 'actions', 'name' => 'delete_actions',  'display_name' => 'удаление', 'description' => 'Удаление истории',        ],
            /* 40 */ ['group' => 'actions', 'name' => 'view_actions',    'display_name' => 'просмотр', 'description' => 'Просмотр полной истории.',        ],
